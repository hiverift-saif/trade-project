...
function TradePanel({
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-[60px] left-0 right-0 md:static md:w-[20rem] bg-[#0b0f1a] border-t md:border-t-0 md:border-l border-zinc-800/50 p-4 flex flex-col shadow-lg rounded-t-lg md:rounded-none z-50 transition-transform duration-300 ease-in-out md:transition-none md:transform-none max-h-[calc(100vh-120px)] md:max-h-[calc(100vh-140px)] overflow-y-auto ${
        ...
        <div className="flex-1 overflow-y-auto space-y-4">
          ...
          <div className="mb-4">
            <Stat
              ...
              accent="text-emerald-400 font-medium"
            />
          </div>
