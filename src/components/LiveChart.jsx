...
const sideColor =
  ...
  return (
    <div className="p-4 bg-[#071124] min-h-screen">
      <div className="max-w-6xl mx-auto">
        {/* Toolbar */}
        <div className="flex flex-wrap justify-between items-center bg-[#0b1520] border border-gray-800 p-3 rounded-lg">
          <div>
            <label className="text-gray-400 text-sm mr-2">Chart Type:</label>
            <select
              value={chartType}
              onChange={(e) => {
              ...
              className="bg-[#1a2436] text-white rounded px-2 py-1"
            >
