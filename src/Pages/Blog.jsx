...
import BlogCard from '../AboutContent/Blogcard.jsx';

const Blog = () => {
  return (
    
          <div className="">
      <section className="relative h-[450px] rounded-b-2xl overflow-hidden">
  ...
  <div className="container mx-auto px-4 text-white">
    ...
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full px-4 md:pl-30">
      ...
      >
        ...
        <li className="font-semibold text-white">Blogs</li>
      </ul>
    </div>
  </div>
</div>
